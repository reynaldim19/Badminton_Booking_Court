    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">Jadwal Booking</a>
          </li>
          <li class="nav-item">
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_assoc($proses)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="book.php?id=<?php echo $row['id']; ?>"><i data-feather="edit"></i></a> |
                      <a href="hapus.php?id=<?php echo $row['id']; ?>"><i data-feather="trash"></i></a>
                    </td>
                  </tr>
                  <?php
                  $nomor++;
